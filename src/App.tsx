...
function App() {
 ...
 useEffect(() => {
  ...
  scrollTrigger: {
    ...
    start: "top 0%", // trigger when bottom of element hits 80% of viewport
    end: "bottom 100%", // optional: end when top of element hits 20% of viewport
...
>
  ...
  className="relative min-h-screen w-full bg-white z-40 rounded-t-[3rem] rounded-b-[3rem] texture-overlay opacity-100 translate-y- 10"
>
     ...
     {/* Contact Section */}
      {showContact && (
        ...
        > 
          {/* Main Heading */}
          <h2 className="text-4xl md:text-6xl font-bosenAlt text-white/80 text-center mb-4 tracking-wide">
